      ...
      <Container>
        ...
        <div className="story pt-[120px] pb-[96px]">
          ...
          <div className="mt-[84px] flex justify-between items-start gap-x-[80px]">
            ...
            <p className="story_pragraph mt-[30px]"> My journey into design began at the
              end of 2023, when I discovered a deep interest in creating
              user-friendly and visually engaging digital experiences. Since
              then, I’ve been learning and growing every day, exploring UI/UX
              principles, studying real-world products, and building designs
              that solve real problems. I believe in continuous learning, and
              thoughtful design.</p>
            </div>
          </div>
          <div className="mt-[84px] flex justify-between items-start gap-x-[80px]">
