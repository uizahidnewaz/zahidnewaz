  ...
  return (
    <Container>
      <AnimatePresence>
        {isVisible && (
          <motion.div
            className="popup_box fixed top-1/2 translate-y-[-85%] left-1/2 translate-x-[-50%] w-[96%] md:w-[677px] bg-[var(--color-white-solid)] text-black rounded-[12px] z-50 p-6 shadow-lg"
