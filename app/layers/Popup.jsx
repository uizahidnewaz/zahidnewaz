    ...
    <AnimatePresence>
      {isVisible && (
        ...
        >
          ...
          <button
            onClick={handleClose}
            className="popup_button mt-6 w-full bg-[var(--color-chartreuse-green-60)] py-[10px] rounded-[8px] cursor-pointer hover:bg-[var(--color-chartreuse-green-70)] transition-colors"
          >
            I Understand
          </button>
        </motion.div>
